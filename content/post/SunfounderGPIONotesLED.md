---
title: "Raspberry Pi GPIO in Go and C - Blinking LED"
description: "How to use the Raspberry Pi's GPIO pins to cause an LED to blink"
date: 2021-10-01T13:13:42-06:00
draft: false
image: "images/pwmfordummies/IMG_9133-5.png"
...
This is the first article in a series that explores GPIO programming on a Raspberry Pi 3B+. You can find the full series [here](../../categories/gpio). It is a supplement to the [Sunfounder Blinking LED project](https://docs.sunfounder.com/projects/raphael-kit/en/latest/1.1.1_blinking_led_c.html). The code samples will be in Go and C.
<!--more-->
